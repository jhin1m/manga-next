        ...
        <div className='grid gap-6 md:grid-cols-2'>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Currently configured storage provider</CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Cloudinary storage provider settings</CardDescription>
            </CardHeader>
            <CardContent className='space-y-3'>
              <div className='flex justify-between'>
                <span className='text-sm'>Configured:</span>
                <Badge
                  variant={health.configuration.cloudinary.configured ? 'default' : 'secondary'}
                >
          ...
          <Card>
            ...
            <CardContent className='space-y-3'>
              ...
              <div className='flex justify-between'>
                ...
                <Badge variant='outline'>{health.configuration.s3.provider}</Badge>
              </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>How to configure your storage providers</CardDescription>
            </CardHeader>
            <CardContent className='space-y-3'>
              ...
              <div className='space-y-2'>
                ...
                <ul className='text-sm space-y-1'>
                  <li>
                    •{' '}
                    <a href='/docs/cloudinary-setup.md' className='text-blue-600 hover:underline'>
                      Storage Setup Guide
                    </a>
                  </li>
                  <li>
                    •{' '}
                    <a href='/docs/aws-s3-setup.md' className='text-blue-600 hover:underline'>
                      AWS S3 Setup Guide
                    </a>
                  </li>
                  <li>
                    •{' '}
                    <a
                      href='/docs/s3-compatible-providers.md'

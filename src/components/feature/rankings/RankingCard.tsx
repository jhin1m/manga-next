...
import { Eye, Star, Heart, TrendingUp, TrendingDown, Sparkles, ExternalLink } from 'lucide-react';
...
export default function RankingCard({ manga, category, period, rankIcon }: RankingCardProps) {
      ...
      <CardContent className='p-3 sm:p-4'>
        ...
        <div className='hidden sm:flex items-center gap-4'>
          ...
          <div className='flex-shrink-0'>
            ...
            >
              {rankIcon || <span className='font-bold'>#{manga.rank}</span>}
            </div>
          </div>
              ...
              {category !== 'most_bookmarked' && manga.total_favorites > 0 && (
                <div className='flex items-center gap-1'>
                  ...
                  <span className='font-medium text-foreground'>
                    {formatViews(manga.total_favorites)}
                  </span>
                </div>
              )}
            </div>
        ...
        <div className='sm:hidden space-y-3'>
          ...
          <div className='flex items-start gap-3'>
            ...
            <div className='flex-shrink-0'>
              ...
              >
                {rankIcon || <span className='font-bold text-xs'>#{manga.rank}</span>}
              </div>
            </div>

        ...
        <CardContent className="p-6">
          <div className="space-y-4">
            ...
            <div className="hidden md:block">
              <Tabs value={activeCategory} onValueChange={(value) => onCategoryChange(value as RankingCategory)}>
            ...
            <div className="md:hidden">
              <Select value={activeCategory} onValueChange={(value) => onCategoryChange(value as RankingCategory)}>
                <SelectTrigger>
        ...
        <CardContent className="p-6">
          <div className="space-y-4">
            ...
            <div className="sm:hidden">
              <Select value={activePeriod} onValueChange={(value) => onPeriodChange(value as RankingPeriod)}>
                <SelectTrigger>

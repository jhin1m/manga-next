...
import { Mail, Send, Clock, Briefcase, MessageCircle } from 'lucide-react';
            ...
            <CardContent className='space-y-4'>
              <div className='flex items-start gap-3'>
                ...
                <div>
                  ...
                  <p className='text-sm text-muted-foreground'>{t('info.response')}</p>
                </div>
              </div>
              ...
              <div className='flex items-start gap-3'>
                ...
                <div>
                  ...
                  <p className='text-sm text-muted-foreground'>{t('info.business')}</p>
                </div>
              </div>
            </CardContent>
          </Card>

  ...
  try {
      ...
      return NextResponse.json(
        {
          success: false,
          error:
            'Invalid category. Must be one of: most_viewed, highest_rated, most_bookmarked, trending',
          data: {
            category,
            period,
            rankings: [],
    ...
    switch (category) {
      ...
      case 'trending': {
        ...
        orderBy = [{ [trendingViewField]: 'desc' }, { total_views: 'desc' }, { id: 'asc' }];
        whereClause = {

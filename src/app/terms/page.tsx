...
import { FileText, CheckCircle, AlertTriangle, Scale, UserX, Calendar } from 'lucide-react';
                  ...
                  <CardTitle className='flex items-center gap-3 text-xl'>
                    <div
                      className={`p-2 rounded-lg ${
                        isWarning ? 'bg-yellow-100 dark:bg-yellow-900/30' : 'bg-primary/10'
                      }`}
                    >
                      <IconComponent
                        className={`h-5 w-5 ${
        ...
        <Card className='border-blue-200 bg-blue-50/50 dark:border-blue-800 dark:bg-blue-950/20'>
          <CardContent className='p-6'>
            <div className='flex items-start gap-3'>
              ...
              <div>
                <h3 className='font-semibold text-foreground mb-2'>Legal Agreement</h3>
                <p className='text-muted-foreground text-sm leading-relaxed mb-3'>
                  By using our service, you acknowledge that you have read, understood, and agree to
                  be bound by these Terms of Service. These terms may be updated from time to time,
